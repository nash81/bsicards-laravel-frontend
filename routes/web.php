...
Route::group(['middleware' => ['auth', '2fa', 'isActive', setting('otp_verification', 'permission') ? 'otp' : 'web', setting('email_verification', 'permission') ? 'verified' : 'web'], 'prefix' => 'user', 'as' => 'user.'], function () {
    ...
    Route::get('mastervirtual', [VirtualCardController::class, 'mastervirtual'])->name('mastervirtual');
    Route::get('mastervirtualview/{id}', [VirtualCardController::class, 'mastervirtualview'])->name('mastervirtualview');
    Route::post('mastervirtualloadfunds', [VirtualCardController::class, 'mastervirtualloadfunds'])->name('mastervirtualloadfunds');
    Route::post('mastervirtualnew', [VirtualCardController::class, 'mastervirtualnew'])->name('mastervirtualnew');
    Route::get('mastervirtualblock/{id}', [VirtualCardController::class, 'mastervirtualblock'])->name('mastervirtualblock');
    Route::get('mastervirtualunblock/{id}', [VirtualCardController::class, 'mastervirtualunblock'])->name('mastervirtualunblock');

    //BSICards VisaCard

    Route::get('visavirtual', [VirtualCardController::class, 'visavirtual'])->name('visavirtual');
    Route::get('visavirtualview/{id}', [VirtualCardController::class, 'visavirtualview'])->name('visavirtualview');
    Route::post('visavirtualloadfunds', [VirtualCardController::class, 'visavirtualloadfunds'])->name('visavirtualloadfunds');
    Route::post('visavirtualnew', [VirtualCardController::class, 'visavirtualnew'])->name('visavirtualnew');
    Route::get('visavirtualblock/{id}', [VirtualCardController::class, 'visavirtualblock'])->name('visavirtualblock');
    Route::get('visavirtualunblock/{id}', [VirtualCardController::class, 'visavirtualunblock'])->name('visavirtualunblock');

    //BSICards Digital Cards
    Route::get('/getalldigital', [VirtualCardController::class, 'getalldigital'])->name('getalldigital');
    Route::get('/getdigitalcard/{id}', [VirtualCardController::class, 'getdigitalcard'])->name('getdigitalcard');
    Route::get('/blockdigital/{id}', [VirtualCardController::class, 'blockdigital'])->name('blockdigital');
    Route::get('/unblockdigital/{id}', [VirtualCardController::class, 'unblockdigital'])->name('unblockdigital');
    Route::get('/terminatedigital/{id}', [VirtualCardController::class, 'terminatedigital'])->name('terminatedigital');
    Route::post('/activatedigital/{id}', [VirtualCardController::class, 'activatedigital'])->name('activatedigital');
    Route::post('/updatephonedigital/{id}', [VirtualCardController::class, 'updatephonedigital'])->name('updatephonedigital');
